...
def test_early_return_loop_workflow_with_session(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_early_return_loop_workflow_early_return(monkeypatch: pytest.MonkeyPatch) -> None:
