...
impl waymark_vm_interpreter_excset::value::AsException for TestReadyValue {
    fn as_exception(
        &self,
    ) -> Result<
    ...
    > {
        match self {
            ...
            Self::Int(_) | Self::Bool(_) | Self::Text(_) | Self::List(_) => {
                Err(waymark_vm_interpreter_excset::value::AsExceptionError::NotAnException)
            }
        }
    }
}
...
impl waymark_vm_interpreter_excset::value::AsExceptionTypeId for TestReadyValue {
    fn as_exception_type_id(
        ...
        match self {
            ...
            Self::Int(_) | Self::Bool(_) | Self::Exception(_) | Self::List(_) => Err(
...
impl waymark_vm_interpreter_excset::value::AsException for TestValue {
    fn as_exception(
        &self,
    ) -> Result<
        &waymark_vm_runtime_exception::Exception<Self::RootValue>,
