...
#[derive(Debug)]
pub struct ActionCallParams<ActionResult> {
...
pub trait SideEffectApplicator {
    ...
    type ActionResultValue: Clone;

    fn action_call(
        &mut self,
        iteration_index: Option<i32>,
        params: ActionCallParams<Self::ActionResultValue>,
    ) -> Result<Self::ActionResultValue, Self::ActionCallError>;
}

type ValueExprFor<SideEffectApplicator> =
    ValueExpr<<SideEffectApplicator as self::SideEffectApplicator>::ActionResultValue>;
    ...
    SideEffectApplicator: self::SideEffectApplicator,
{
    ...
    pub fn action_spec_from_ir(
        ...
        ActionCallSpec<SideEffectApplicator::ActionResultValue>,
        ExprToValueError<SideEffectApplicator::ActionCallError>,
    > {
        let kwargs = action
            .kwargs
    ...
    pub fn action_call(
        ...
        SideEffectApplicator::ActionResultValue,
        ExprToValueError<SideEffectApplicator::ActionCallError>,
    > {
