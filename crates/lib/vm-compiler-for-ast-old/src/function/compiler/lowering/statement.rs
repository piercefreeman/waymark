...
use super::exception::{
    ExceptionHandlerDispatch, ExceptionMarker, ExceptionScope, ExceptionScopeStack,
};
    ...
    Lowering: waymark_vm_compiler_for_ast_old_core::lowering::FullSet<Spec>,
{
    ...
    fn prepare_exception_handlers(
        ...
        let exception_register = Marked::mark(self.context.local_frame.allocate_register());
