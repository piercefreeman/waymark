...
pub enum StartError {
    ...
    ReadSchemaPool(#[source] waymark_observability_store_postgres_bringup::ReadSchemaPoolError),
...
pub async fn start(
    ...
    let read_pool = waymark_observability_store_postgres_bringup::read_schema_pool(
