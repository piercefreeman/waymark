...
pub struct Params<NodeId> {
    ...
    /// Bucket width; samples within one bucket are aggregated (gauges
    /// averaged, cumulative counters and timestamps at their maximum,
    /// histogram counts and sums added).
