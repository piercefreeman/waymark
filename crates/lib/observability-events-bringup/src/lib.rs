...
where
    ...
    <ReadBackend as waymark_observability_events_query_backend::ListEvents>::Cursor:
        waymark_http_api_types::CursorCodec,
    ReadBackend: waymark_observability_events_query_backend::Tail,
    <ReadBackend as waymark_observability_events_query_backend::Tail>::Cursor:
        waymark_http_api_types::CursorCodec,
    ReadBackend: waymark_observability_events_query_backend::VmTimeline,
    <ReadBackend as waymark_observability_events_query_backend::VmTimeline>::Cursor:
        waymark_http_api_types::CursorCodec,
    ReadBackend:
    ...
    ReadBackend: waymark_observability_events_query_backend::HasPayload<
            Payload = <WriteBackend as waymark_observability_events_sink_backend::HasPayload>::Payload,
        >,
    ReadBackend: Send + Sync + 'static,
    <ReadBackend as waymark_observability_events_query_backend::HasPayload>::Payload:
        waymark_api_observability_events_http::PayloadBounds,
{
