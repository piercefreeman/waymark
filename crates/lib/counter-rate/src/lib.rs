    ...
    Total: crate::Total,
{
    ...
    pub fn observe(
        ...
        // A later reading can still be zero or fewer seconds after the
        // baseline: after a baseline taken in a chrono leap second, the next
        // day's first instants compare as later, yet subtract to zero or
        // less. Such a window is floored, not refused; never divide by zero.
